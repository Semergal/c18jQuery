...
/* Ќаписать метод jQuery.prototype.html(), который возвращает или измен€ет html-содержимое выбранных элементов. */
jQuery.prototype.html = function (name = this.elements["0"].innerHTML) {
	this.each(element => element.innerHTML = name);
	return this.elements["0"].innerHTML;
}

/*Ќаписать метод jQuery.prototype.text(), который возвращает или измен€ет текстовое содержимое выбранных элементов. */
